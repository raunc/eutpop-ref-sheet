...
\begin{itemize}
	...
	\begin{itemize}
		\item A \strong{Prov.}/\strong{Unit}/\strong{token} is Adj. to their Area, to ones sharing a border with it and to Prov. in them
		\item A \strong{Port} is Adj. also to its Sea Zones, to Ports facing them and to their Areas
		\item \strong{Areas}/\strong{Sea Zones} are Adj. if they share a border or have Ports facing the same Sea Zone
		\item A \strong{Realm} is Adj. if an Own Prov. is Adj.
	\end{itemize}
	...
	\item \strong{Hostile}:
	\begin{itemize}
		\item Armies/Units/Prov. Controlled by \rebels/Realms at War with you
		\item Areas with Hostile Units/Prov.
		\item Sea Zones with Hostile Ships
		\item Sea Zones facing Hostile NPR Ports \conj{and} with no Ship Hostile to them
	\end{itemize}
	...
	\item \strong{Occupied Province}: has Occ. token \conj{or} 2 \rebeltown/\town/\vassal (Controller on top, Lawful Owner on bottom)
...
\begin{itemize}
	...
	\begin{itemize}
		\item Towns (\town), but have replacements (p.~21)
		\begin{itemize}
			\item If out of Large \towns, use 2 Small \towns
			\item If out of Small \towns, use a \vassal
		\end{itemize}
