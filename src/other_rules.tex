...
\begin{itemize}
	...
	\item Discount of 1\adminpower of \action{Development}
	\item May \action{Change State Religion} to Catholicism
\end{itemize}

\subsubsection*{Orthodoxy abilities}
\begin{itemize}
	\item Discount of 1\adminpower when \action{Increasing Stability} from -1 to 0 or from 0 to 1
\end{itemize}
...
\subsubsection*{HRE Religion \normal{(adv. rules) (p.~45)}}
\begin{itemize}
	\item Emperor may \action{Change State Religion} only when HRE Religion has changed
...
\begin{itemize}
	...
	\item Otherwise -- Bot's MC for the Area + 3 (min 9, if Naval Bridge to an Area with land connection to the Capital)
