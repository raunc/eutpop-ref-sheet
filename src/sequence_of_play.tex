...
\newlength{\fhManpower} \setlength\fhManpower{8\baselineskip}
\newlength{\fhImpInfluence} \setlength\fhImpInfluence{11\baselineskip}
...
\newlength{\fhPowerStruggle} \setlength\fhPowerStruggle{8\baselineskip}
...
\setlength{\frameCrusadeY}{\calc{\frameBotDeckY - \fhCrusade - 2\frameToFrameSpacing}}
...
\setdynamicframe*{frameBotDeck}{bordercolor=botrulescolor}
...
\subsubsection*{D. Peace Resolutions\zsavepos{arrowPeaceSeqStart}}\framebreak%
...
\begin{dynamiccontents*}{frameArrowsPageOne}
	...
	\newlength{\peaceStartY} \setlength{\peaceStartY}{\calc{\zposy{arrowPeaceSeqStart}sp+3pt}}
	\newlength{\peaceStartX} \setlength{\peaceStartX}{\calc{\zposx{arrowPeaceSeqStart}sp+\arrowToTextSpacing}}
...
\begin{itemize}
	...
	\item Power Struggles\zsavepos{arrowPowerStruggleStart}
...
\begin{dynamiccontents*}{frameManpower}
	...
	\begin{itemize}
		\item Max 20
		\item \botrule{Bots have min 3 (p.~3)}
		\item When increases
		\begin{itemize}
		...
		\begin{itemize}
			...
			\item \botrule{Bots rem. from Reserve first (p.~3)}
		\end{itemize}
	\end{itemize}
\end{dynamiccontents*}
...
\begin{itemize}
	...
	\item \hspacezero\zsavepos{arrowBotDeckStart}\botrule{Reshuffle Bot deck (p.~3)}
\end{itemize}
...
\begin{itemize}
	...
	\item Score \p1 per \core 
	\item Score \p1 per \marriage
	\item Score \p2 per \alliance
...
%	\item If equal \prestige, tie breakers: 1.~most \monarchpower, 2.~most \ducats%
\end{itemize}
