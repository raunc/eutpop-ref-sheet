...
\begin{dynamiccontents*}{frameArrowsPageOne}
	...
	\newlength{\peaceTurnX} \setlength{\peaceTurnX}{\arrowXVerticalLeft}
	\newlength{\peaceTurnY} \setlength{\peaceTurnY}{\calc{\margin + \fhPeaceSeq + .5\columnsep}}
...
\begin{dynamiccontents*}{frameArrowsPageTwo}
	...
	\newlength{\peaceTurnYContinue} \setlength{\peaceTurnYContinue}{\calc{\margin + \fhPeaceSeq + .5\columnsep}}
	...
	\newlength{\peaceTurnXTwo} \setlength{\peaceTurnXTwo}{\arrowXVerticalLeft}
