...
\end{itemize}
\smallheading{Optional Rule 7: Revealing More (p.~39)}
\begin{itemize}
...
\begin{dynamiccontents*}{frameArrowsPageOne}
	...
	\newlength{\peaceTurnX} \setlength{\peaceTurnX}{\calc{\peaceSeqEndX + \arrowAdjustXTurnBeforeEnd}}
	\newlength{\peaceTurnY} \setlength{\peaceTurnY}{\calc{\peaceSeqEndY + \arrowAdjustYTurnBeforeBox}}

	\drawArrow{(\pagewidth,\peaceTurnY) -- (\peaceTurnX,\peaceTurnY) -- (\peaceTurnX,\peaceSeqEndY) -- (\peaceSeqEndX,\peaceSeqEndY)}
	...
	\newlength{\nprTurnY} \setlength{\nprTurnY}{\calc{\nprEndY + \arrowAdjustYTurnBeforeBox}}
...
\subsubsection*{\zsavepos{arrowPeaceStart}D. Peace Resolutions}
...
\begin{dynamiccontents*}{frameArrowsPageTwo}
	...
	\newlength{\peaceTurnYContinue} \setlength{\peaceTurnYContinue}{\calc{\zposy{arrowPeaceSeqEnd}sp + \arrowAdjustYBeforeSubsub + \arrowAdjustYTurnBeforeBox}}
	\newlength{\peaceStartY} \setlength{\peaceStartY}{\calc{\zposy{arrowPeaceStart}sp + \arrowAdjustYBeforeSubsub}}
	\newlength{\peaceStartX} \setlength{\peaceStartX}{\zposx{arrowPeaceStart}sp}
	...
	\newlength{\peaceTurnXTwo} \setlength{\peaceTurnXTwo}{\calc{\peaceTermsEndX + \arrowAdjustXTurnBeforeEnd}}

	\drawLine{(\peaceStartX, \peaceStartY) -- (\peaceTurnXTwo,\peaceStartY) -- (\peaceTurnXTwo,\peaceTurnYContinue) -- (0mm,\peaceTurnYContinue)}
	\drawArrow{(\peaceStartX, \peaceStartY) -- (\peaceTurnXTwo,\peaceStartY) -- (\peaceTurnXTwo,\peaceTermsEndY) -- (\peaceTermsEndX,\peaceTermsEndY)}
