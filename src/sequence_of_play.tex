...
\begin{itemize}
	\item In order, each human PR rolls Area by Area, for all their \unrest in a given Area (p.~37)
	\item \botrule{Bots roll for all Areas at once (max 5 dice) (p.~4)}
\end{itemize}
...
\begin{itemize}
	...
	\item \botrule{Discard Bot \colonists if no vacant Terr. (p.~3)}
