...
\newlength{\fhPeaceSeq} \setlength\fhPeaceSeq{33.5\baselineskip}
\newlength{\fhPeaceTerms} \setlength\fhPeaceTerms{45.5\baselineskip}
\newlength{\fhSecondPageLower} \setlength\fhSecondPageLower{\calc{\textheight - \fhPeaceTerms - \frameToFrameSpacing}}

\newlength{\fhFirstPageShortCol}
\setlength\fhFirstPageShortCol{\calc{\textheight-\fhNprInvasions-\fhPeaceSeq-\frameToFrameSpacing-\frameToTextSpacing}}
...
\newlength{\frameImpInfluenceY}
\setlength{\frameImpInfluenceY}{\calc{\frameManpowerY - \fhImpInfluence - \frameToFrameSpacing}}
\newlength{\frameHreReligionY}
\setlength{\frameHreReligionY}{\calc{\frameImpInfluenceY - \fhHreReligion - \frameToFrameSpacing}}
\newlength{\frameBotDeckY}
\setlength{\frameBotDeckY}{\calc{\frameHreReligionY - \fhBotDeck - \frameToFrameSpacing}}
\newlength{\frameCrusadeY}
\setlength{\frameCrusadeY}{\calc{\frameBotDeckY - \fhCrusade - \frameToFrameSpacing}}
\newlength{\framePowerStruggleY}
\setlength{\framePowerStruggleY}{\calc{\frameCrusadeY - \fhPowerStruggle - \frameToFrameSpacing}}

% Text Columns
\usepackage{flowfram}
\newflowframe[1,3]{\columnwidth}{\textheight}{0mm}{0mm}[leftColFullHeight]
\newflowframe[1]{\columnwidth}{\fhFirstPageShortCol}{\middleColX}{0mm}[firstPageMiddleCol]
\newflowframe[1]{\columnwidth}{\fhFirstPageShortCol}{\rightColX}{0mm}[firstPageRightCol]
\newflowframe[2]{\columnwidth}{\fhSecondPageLower}{0mm}{0mm}[secondPageLeftCol]
\newflowframe[3]{\columnwidth}{\textheight}{\rightColX}{0mm}[rightColFullHeight]

% Text Frames
\newdynamicframe[1]{\fwTwoCols}{\fhNprInvasions}
	{\middleColX}{\calc{\textheight - \fhNprInvasions}}[frameNprInvasions]
\newdynamicframe[1]{\fwTwoCols}{\fhPeaceSeq}
	{\middleColX}{\calc{\textheight - \fhNprInvasions - \fhPeaceSeq - \frameToFrameSpacing}}[framePeaceSeq]

\newdynamicframe[2]{\textwidth}{\fhPeaceTerms}
	{0mm}{\calc{\textheight - \fhPeaceTerms}}[framePeaceTerms]
\newdynamicframe[2]{\fwTwoCols}{\fhSecondPageLower}{\middleColX}{0mm}[framePeaceMisc]
...
\begin{itemize}
	\item NPRs at War might invade PRs\zsavepos{arrowNprInvasionsStart}
	\botrules
...
\begin{dynamiccontents*}{framePeaceSeq}\begin{eubox}{\fhPeaceSeq}
	\begin{multicols}{2}
		\subsubsection*{\zsavepos{arrowPeaceSeqEnd}Peace Resolution Sequence \normal{(p.~29)}}
		\begin{itemize}
		...
		\begin{itemize}
			...
			\item If Peace is made with an \strong{Active Ally}, the Allied PR must remove (p.~30)
			\begin{itemize}
		...
		\begin{itemize}
			...
			\item If Enemy \strong{Surrenders} (p.~30)
			\begin{itemize}
			...
			\end{itemize}
			\item If PR Enemy has \strong{Active Allies} (p.~30)
			\begin{itemize}
...
\begin{dynamiccontents*}{framePeaceTerms}\begin{eubox}{\fhPeaceTerms}
	...
	\end{multicols}
\end{eubox}\end{dynamiccontents*}%
\begin{dynamiccontents*}{framePeaceMisc}\begin{eubox}{\fhSecondPageLower}
	\begin{multicols}{2}
...
\begin{itemize}
	\item Each human PR rolls Area by Area, for all their \unrest in a given Area (p.~37)
...
\hline
\rowcolor{tblbgTax} + Base Tax Income & \\ \hline
\rowcolor{tblbgTax} + Vassal Tax Income & \\ \hline
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item If 6 \conj{or} ≥ current \authority + 2, gain 1\authority
			\item If 1 \conj{or} ≤ current \authority~- 2, lose 1\authority
		\end{itemize}
	\end{itemize}
