...
\begin{dynamiccontents*}{frameArrowsPageOne}
	...
	% Peace Resolution arrow
	\newlength{\peaceStartY} \setlength{\peaceStartY}{\calc{\zposy{arrowPeaceSeqStart}sp+\arrowAdjustYBeforeSubsub}}
	\newlength{\peaceStartX} \setlength{\peaceStartX}{\calc{\zposx{arrowPeaceSeqStart}sp}}
	\newlength{\peaceEndY} \setlength{\peaceEndY}{\calc{\zposy{arrowPeaceSeqEnd}sp-7pt}}
	\newlength{\peaceEndX} \setlength{\peaceEndX}{\zposx{arrowPeaceSeqEnd}sp}
	\newlength{\peaceTurnX} \setlength{\peaceTurnX}{\calc{\peaceEndX-3.5mm}}

	\drawArrow{(\peaceStartX, \peaceStartY) -- (\peaceTurnX,\peaceStartY) -- (\peaceTurnX,\peaceEndY) -- (\peaceEndX,\peaceEndY)}

	% NPR Invasions arrow
	\newlength{\nprStartY} \setlength{\nprStartY}{\calc{\zposy{arrowNprInvasionsStart}sp + \arrowAdjustYText}}
	\newlength{\nprStartX} \setlength{\nprStartX}{\calc{\zposx{arrowNprInvasionsStart}sp + \arrowToTextSpacing}}
...
\begin{dynamiccontents*}{frameArrowsPageThree}
	...
	\begin{tikzpicture}
		...
		\newlength{\manpowerTurnX} \setlength{\manpowerTurnX}{\calc{\manpowerStartX-2mm}}
		...
		\newlength{\impinfTurnX} \setlength{\impinfTurnX}{\calc{\impinfStartX-2mm}}
		...
		\newlength{\hreTurnX} \setlength{\hreTurnX}{\calc{\hreStartX-2mm}}
		...
		\newlength{\botDeckTurnX} \setlength{\botDeckTurnX}{\calc{\botDeckStartX-2mm}}
		...
		\newlength{\crusadeTurnX} \setlength{\crusadeTurnX}{\calc{\crusadeEndX-4.5mm}}
		...
		\newlength{\powerTurnX} \setlength{\powerTurnX}{\calc{\powerEndX-3.4mm}}
