	...
	% \begin{multicols}{2}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				% \item \botrule{\hspacezero\zsavepos{arrowBotDefSubjectStart}Bot Emp. defends targeted Subj. (p.~6)\zsavepos{arrowBotDefSubjectEnd}}
			\end{itemize}
		\end{itemize}
	% \end{multicols}
\end{eubox}\end{dynamiccontents*}
...
\begin{dynamiccontents*}{frameDefHre}\begin{eubox}{\fhDefHre}
	% \begin{multicols}{2}
		...
		\begin{itemize}
				...
				\item \hspacezero\zsavepos{arrowBotDefSubjectEnd}PR Emperor receives \emph{Defensive CtA} if
			\begin{itemize}
...
\begin{dynamiccontents*}{frameArrowsPageOne}
	...
	\newlength{\activateAllyOneEndX} \setlength{\activateAllyOneEndX}{\zposx{arrowActivateAllyEndOne}sp}
	...
	\newlength{\botDefSubjectEndX} \setlength{\botDefSubjectEndX}{\calc{\zposx{arrowBotDefSubjectEnd}sp + \arrowAdjustXBeforeList}}
	\newlength{\botDefSubjectTurnX} \setlength{\botDefSubjectTurnX}{\arrowXVerticalLeft}
