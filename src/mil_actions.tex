...
\newlength{\frameBattleSeqNoteY} \setlength\frameBattleSeqNoteY{\calc{\fhBattleSequence + \frameToTextSpacing}}
...
\begin{dynamiccontents*}{frameBattleSeqNote}
	\botrule{
		NOTE: If Bot is Attacker or Main Def., then Batt. Seq. has differ. not covered here (p.~5-6)
	}
\end{dynamiccontents*}
